...
const REALMS = [
  {
    ...
    lore: "The Realm of Minimalism is a landscape of calm horizons and uncluttered paths. Here, every piece has a purpose. Colours are muted, silhouettes are simple, and nothing shouts for attention—yet everything feels intentional.",
    unlockEssence: 0,
    orderIndex: 1,
    position: 78,
  ...
  },
  {
    ...
    lore: "At the Streetwear Docks, the city's pulse never stops. Oversized hoodies, graphic tees, and sneakers line the boardwalk like ships ready to sail. This realm is for those who move with rhythm—expressive, layered, and unapologetically present.",
    unlockEssence: 10,
  ...
  },
  {
    ...
    lore: "The Soft Academia Realm is filled with worn books, warm lamplight, and rainy windows. Cardigans, pleated skirts, and soft sweaters wrap around you like a story you never want to end.",
    unlockEssence: 20,
    prerequisiteSlug: "realm_minimalism",
    orderIndex: 3,
    position: 52,
  ...
  },
  {
    ...
    lore: "In the Monochrome Realm, color fades to shadow and light. Every garment is a study in contrast—bold, sharp, and timeless. This is the realm of those who believe less is always more.",
    unlockEssence: 35,
    prerequisiteSlug: "realm_minimalism",
    orderIndex: 4,
    position: 39,
  ...
  },
  {
    ...
    lore: "The Earthbound Realm blooms with terracotta, sage, and sand. Here, fashion is rooted in the earth—organic, grounded, and endlessly comforting.",
    unlockEssence: 50,
  ...
  },
  {
    ...
    lore: "In the Techwear Realm, the future has arrived. Functional zippers, waterproof fabrics, and modular designs turn clothing into equipment. Every piece serves a purpose.",
    unlockEssence: 70,
